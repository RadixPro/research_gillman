...
public class CalculationHandler {
    ...
    public void performCalculation(final String fileIndicator) {
        ...
        final List<FullChart> calculatedCharts = calculator.calculateSet(inputDataCollection);
        final CalculationResultCollection calculationResultCollection = new CalculationResultCollection(); // TODO autowire, no singleton
        calculationResultCollection.setDescription("Calculated results for : " + fileIndicator);
